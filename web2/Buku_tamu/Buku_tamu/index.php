        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Tambah Data Tamu</span></a>
						<a href="#deleteEmployeeModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE15C;</i> <span>Hapus Semua Yang Di Tandai</span></a>						
					</div>
                </div>
			</div>
			...
			<div class="modal-content">
				<form method="post" action="index.php">
					<div class="modal-header">						
						<h4 class="modal-title">Tambahkan Data Tamu</h4>
					...
					<div class="modal-footer">
						...
						<input type="submit" class="btn btn-success" name="add" value="Tambahkan">
					</div>
				</form>
			</div>
		</div>
